...
| `* *`    | expert user             | quickly filter contacts based on a combination of roles, status and tag groups | I can easily look for specific contacts that match some unique properties                    |
...
| `*`      | expert user             | apply filters in more complex configurations like match all or match any       | I can have finer control over filtering                                                      |
